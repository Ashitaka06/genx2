...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "genX")
if WEBUI_NAME != "genX":
    WEBUI_NAME += " (genX)"

WEBUI_FAVICON_URL = "https://genx.datax.iliad.fr/favicon.png"
...
if os.path.exists(f"{DATA_DIR}/ollama.db"):
    ...
    log.info("Database migrated from Ollama-genX successfully.")
else:
    pass
