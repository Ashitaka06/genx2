...
- **🔧 Additional Environment Variables**: Discover more environment variables in our comprehensive documentation at genX Documentation (https://docs.openwebui.com).
